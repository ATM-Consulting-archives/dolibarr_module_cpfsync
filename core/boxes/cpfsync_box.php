 ...
 */
class cpfsyncbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "cpfsync@cpfsync";
    public $boxlabel;
    public $depends = array("cpfsync");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/cpfsync/class/cpfsync.class.php";
